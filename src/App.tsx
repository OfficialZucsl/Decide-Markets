...
const seedMarketIds = new Set(['m1','m2','m3','m4','m5','m6','m7','m8','m9','m10']);
    ...
    if (isSeedMarket) {
      setMarkets(prev => prev.map(m => {
        if (m.id === selectedMarket.id) {
          ...
          return { ...m, yesPoints: newQYes, noPoints: newQNo };
        }
        return m;
      }));
  ...
  const adminCurateMarkets = async () => {
    ...
    try {
      for (const market of simulatedLiveNews) {
        ...
        await setDoc(marketRef, { ...market, createdAt: new Date().toISOString() });
      }
                ...
                >
                  ...
                  <div className="mt-auto">
                    <div className="flex items-baseline space-x-1 mb-4">
                      <span className="text-6xl font-bold tracking-tighter">{Math.round(prob)}</span>
